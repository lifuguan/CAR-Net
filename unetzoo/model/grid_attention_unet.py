...
# Title:
# Arxiv:
# Source: https://github.com/ztzhao6/Liver-Segmentation-with-AttentionUNet/blob/master/net_framework.py
# Date: 2021-02-06
#
...
class Grid_Attention_UNet3D(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(Grid_Attention_UNet3D, self).__init__()
...
class Grid_Attention_UNet2D(nn.Module):
    def __init__(self, n_channels, n_classes, useBN=True, pretrained=False):
        super(Grid_Attention_UNet2D, self).__init__()
...
if __name__ == '__main__':
    ...
    model = Grid_Attention_UNet2D(1,3).to(device)
    summary(model,(1,144,144))    # Succeed!
