...
# Arxiv: https://doi.org/10.1371/journal.pone.0221535
# Paper: https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0221535
# Source: https://github.com/Rb-Liu/adr-unet/blob/master/nets/model.py
# Date: 2021-02-06
#
...
class RDA_UNet(Module):
    def __init__(self):
        super(RDA_UNet, self).__init__()
...
if __name__ == '__main__':
    ...
    model = RDA_UNet().to(device)
    print(model)
    summary(model,(1,576,576))   # Succeed!
