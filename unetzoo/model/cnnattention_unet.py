...
# Title:
# Arxiv:
# Source: https://github.com/qbTrible/Attention-Unet
# Source: https://github.com/qbTrible/Attention-Unet/blob/master/Attention_UNet.py
# Date: 2021-02-06
#
...
class CNNAttention_UNet(torch.nn.Module):
    def __init__(self, nChannels):
        super(CNNAttention_UNet, self).__init__()
        self.attetion1 = CNNAttetion(1, nChannels//2)
        self.C1 = CNNLayer(1, nChannels)
        self.D1 = DownSampling(nChannels)
...
if __name__ == '__main__':
    ...
    model = CNNAttention_UNet(16).to(device)
    print(model)
