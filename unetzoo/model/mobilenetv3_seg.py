...
Arxiv: https://arxiv.org/pdf/1905.02244.pdf
source: https://github.com/xiaolai-sqlai/mobilenetv3
'''
import os
import torch
...
class MobileNetV3(nn.Module):
    def __init__(self, nclass=1, mode='large', width_mult=1.0, dilated=False, norm_layer=nn.BatchNorm2d):
...
class MobileNetV3Seg(nn.Module):
    ...
    def forward(self, x):
        ...
        c1 = self.model.layer2(x)
        c2 = self.model.layer3(c1)
        c3 = self.model.layer4(c2)
