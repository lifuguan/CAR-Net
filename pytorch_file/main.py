...
parser.add_argument('-m', '--model', type=str, choices=['atten_gate', 'unet', 'unet_resnet', 'stand_alone_self_attention'], default='unet_resnet')
parser.add_argument('-d', '--dataset', type=str, choices=['liver', 'drive'], default='liver')
...
if args.model == 'atten_gate':
    ...
    model = get_unet_depthwise_light_encoder_attention_with_skip_connections_decoder(1,1)
...
liver_dataset = LiverDataset(state='train', scale=501 if args.model == "unet_resnet" else 512)
